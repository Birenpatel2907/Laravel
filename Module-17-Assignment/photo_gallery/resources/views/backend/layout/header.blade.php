            ...
            <nav id="sidebar">
               ...
               <div class="sidebar_blog_2">
                  ...
                  <ul class="list-unstyled components">
					 ...
					 <li class="active">
                        <a href="addphoto"><i class="fa fa-dashboard yellow_color"></i> <span>Add Photos</span></a>
                     </li>
					 
					 <li class="active">
                        <a href="managephoto"><i class="fa fa-dashboard yellow_color"></i> <span>Manage Photos</span></a>
                     </li>
					
					 <li class="active">
                        <a href="manageuser"><i class="fa fa-dashboard yellow_color"></i> <span>Manage User</span></a>
                     </li>
